...
#'
#' @examples
#' sir_mixb(n_particles = 100, x0 = 10, death_rate = 0.1, sigma = 0.1, proportion_obs = 0.1, noisy_prevalence = noisy_prev, genetic_data = gen_data)
sir_mixb <- function(n_particles, ess_threshold = n_particles/2, x0 = 1, death_rate, sigma, proportion_obs, noisy_prevalence, genetic_data, resampling_scheme = "systematic", backward_sim = TRUE) {
