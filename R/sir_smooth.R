#' Sample Importance Resample (Smooth)
#'
#' Implements an SIR algorithm and returns an approximated log-likelihood. Proposals are centred on the smoothed prevalence.
#'
...
#'
#' @examples
#' sir_smooth(n_particles = 100, birth_rate = 0.2, death_rate = 0.1, noisy_prevalence = noisy_prev, proportion_obs = 0.2, genetic_data = gen_data)
sir_smooth <- function(n_particles, birth_rate, death_rate, noisy_prevalence, proportion_obs, genetic_data, plot=F) {
