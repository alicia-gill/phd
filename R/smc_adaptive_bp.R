...
smc_adaptive_bp <- function(iter, birth_rate_0, max_birth_rate=100, proportion_obs_0, death_rate, ptree, noisy_prevalence, n_particles, ess_threshold = n_particles/2, print=F, plot=F) {
